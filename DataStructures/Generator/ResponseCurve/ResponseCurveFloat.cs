...
namespace Gamelogic.Extensions.Algorithms
{
	...
	public class ResponseCurveFloat : ResponseCurveBase<float>
	{
		...
		{
			return outputSampleMin + (outputSampleMax - outputSampleMin) * GLMath.Clamp01(t);
		}
	...
	public class ResponseCurveInt : ResponseCurveBase<int>
	{
		...
		{
			return GLMath.RoundToInt(outputSampleMin + (outputSampleMax - outputSampleMin) * GLMath.Clamp01(t));
		}
