		...
		*/
			...
			*/
			...
			public override void MoveNext()
			{
				if (buckets != null)
				{
					...
					int derivedRandomInt = GLMath.FloorToInt(randomBase);
		...
		private sealed class DitherGenerator : AbstractGenerator<int>
		{
			...
			public override void MoveNext()
			{
				...
				current = GLMath.Clamp(GLMath.FloorToInt(scaledValue + error), 0, levels - 1);
		...
		{
			private readonly IGenerator<TSource> generator;
			private readonly System.Collections.Generic.Queue<TSource> queue;
			...
			public WindowGenerator(IGenerator<TSource> generator, int n)
			{
				...
				queue = new System.Collections.Generic.Queue<TSource>();
